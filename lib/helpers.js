...
helpers.interpolate = function(str, data) {
  ...
  // Add the template globals to the data object, prepending their key name with
  // globals
  ...
  // For each key in the data object, insert the values into the string at the
  // corresponding template place
  for (var key in data) {
...
// Get the contents of a static directory
