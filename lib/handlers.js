                                    ...
                                    userChecks.forEach(function (checkId) {
                                        ...
                                        _data.delete('checks', checkId, function (err) {
                                            ...
                                            if (checksDeleted == checksToDelete) {
                                                if (deletionErrors) {
                                                    callback(500, {
                                                        Error: 'Errors encountered while attempting to delete all of the user checks'
                                                    });
                                                } else {
                                                    callback(200);
                                                }
...
handlers._tokens.put = function (data, callback) {
    ...
    var extend = typeof (data.payload.extend) == 'boolean' && (data.payload.extend == true) ? extend : false;
...
handlers._checks.post = function (data, callback) {
    ...
    var method = typeof (data.payload.method) == 'string' && ['put', 'get', 'post', 'delete'].indexOf(data.payload.method) > -1 ? data.payload.method : false;
...
handlers._checks.get = function (data, callback) {
    ...
    console.log(data.queryStringObject.id.length);
    if (id) {
        // Lookup the check
