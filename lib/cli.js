...
cli.responders.help = function() {
  var commands = {
    ...
    stats:
      "Get statistics of the underlying operating systems and resource utilization",
    "list users":
      "Show a list list of all the registered (undeleted) users in the system",
    ...
    "list logs":
      "Show list of all the log files available to be read (compressed only)",
    ...
    if (!err && checkIds && checkIds.length > 0) {
      ...
      checkIds.forEach(function(checkId) {
        _data.read("checks", checkId, function(err, checkData) {
          ...
          // Get the state, default to unknowm
          var stateOrUnknown =
            typeof checkData.state == "string" ? checkData.state : "unknown";
          // If the user has specified or not specified the state, include accordingly
          if (
...
cli.processInput = function(str) {
  ...
  if (str) {
    ...
    // Go through possible inputs, emit when match is found
