...
server.unifiedServer = function (req, res) {
    ...
    req.on('end', function () {
        ...
        // If the request is within the public directory use public handler
        ...
        chosenHandler(data, function (statusCode, payload, contentType) {
            ...
            if (contentType == 'favicon') {
                ...
                payloadString = typeof(payload) !== 'undefined'
                    ? payload
                    : '';
            }
            if (contentType == 'css') {
            ...
            //  Response the response parts common to all requests
